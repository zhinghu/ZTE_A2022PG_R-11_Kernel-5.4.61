...
struct upgrade_func {
	...
	u32 pb_length;
	int (*init)(void);
	int (*upgrade)(struct i2c_client *client, u8 *buf, u32 len);
	int (*get_hlic_ver)(u8 *initcode);
	int (*lic_upgrade)(struct i2c_client *client, u8 *buf, u32 len);
	int (*param_upgrade)(struct i2c_client *client, u8 *buf, u32 len);
	int (*force_upgrade)(struct i2c_client *client, u8 *buf, u32 len);
};
