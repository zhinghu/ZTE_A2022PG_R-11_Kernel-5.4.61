...
static inline int cts_get_chip_type_num_driver_builtin(void)
{
	return 0;
}
static inline int cts_get_fw_sensor_id_driver_builtin(u32 chip_index, u32 fw_index)
{
	return 0xff;
}
static inline int cts_get_fw_version_driver_builtin(const struct cts_firmware *firmware)
{
	return 0;
}
static inline int cts_get_fw_num_driver_builtin(void)
{
	return 0;
}
static inline int cts_get_chip_type_index_driver_builtin(struct cts_device *cts_dev)
{
	return 0;
}
...
extern const struct cts_firmware *cts_request_firmware_from_sdcard(
