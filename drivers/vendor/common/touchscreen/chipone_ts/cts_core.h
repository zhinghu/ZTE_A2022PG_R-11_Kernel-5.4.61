...
enum cts_device_fw_reg {
	...
	CTS_DEVICE_FW_REG_RX_ORDER = (0x8006 + PHYSICAL_MAX_NUM_ROW), /* +36 */
...
enum cts_devict_hw_reg {
	CTS_DEVICE_HW_REG_PINMUX			   = (0x040400 + 0x001C),
	CTS_DEVICE_HW_REG_GPIO_DIR			   = (0x040400 + 0x0020),
	CTS_DEVICE_HW_REG_GPIO_SET_VAL		   = (0x040400 + 0x0024),
	CTS_DEVICE_HW_REG_GPIO_GET_VAL		   = (0x040400 + 0x0028),
	CTS_DEVICE_HW_REG_GPIO_PULL_DOWN	   = (0x040400 + 0x0038),
	CTS_DEVICE_HW_REG_GPIO_PULL_UP		   = (0x040400 + 0x003C),
};
#else
enum cts_devict_hw_reg {
...
static inline int cts_enable_esd_protection(struct chipone_ts_data *cts_data)
{
	return 0;
}
static inline int cts_disable_esd_protection(struct chipone_ts_data *cts_data)
{
	return 0;
}
