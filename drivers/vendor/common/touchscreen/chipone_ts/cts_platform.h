...
#define cts_err(fmt, ...)   \
	pr_info("<E>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_warn(fmt, ...)  \
	pr_info("<W>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_info(fmt, ...)  \
	pr_info("<I>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_dbg(fmt, ...)   \
	do {                                                    \
...
extern int cts_parse_volt_dt(struct cts_platform_data *pdata, struct device *dev);
extern int cts_volt_enable(struct cts_platform_data *pdata, int on);
extern int cts_volt_remove(struct cts_platform_data *pdata);
